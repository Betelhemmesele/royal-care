        ...
        <div className="flex flex-col md:flex-row justify-between md:space-x-12"> {/* Increased the space between columns */}
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="space-y-3">
              ...
              <li><a href="/contact" className="hover:text-orange-600 transition transform hover:scale-110 duration-200 inline-block">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div className="mb-8 md:mb-0">
            ...
            <ul className="space-y-3">
              ...
              <li><span className="font-semibold">Email:</span> info@royalcaretransportation.com</li>
